...
export type OccurrenceRequest =
  WarningRequest | IllegalParkingRequest | TrafficAccidentRequest;
export type OccurrenceResponse =
  WarningResponse | IllegalParkingResponse | TrafficAccidentResponse;
