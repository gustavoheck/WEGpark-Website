...
O WEGpark é um sistema de gestão de estacionamento corporativo que centraliza o controle de veículos, ocorrências e usuários em uma interface web única, integrada a uma API RESTful. Cada perfil de usuário (colaborador/visitante, guarita, RH administrador) acessa apenas as funcionalidades relacionadas ao seu papel, com notificações, histórico de ocorrências e gestão de usuários integrados em uma experiência responsiva e conectada.
