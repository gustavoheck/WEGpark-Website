...
> Preencher esta tabela conforme os testes forem executados, marcando ✅ (aprovado) ou ❌ (reprovado). Nenhum teste deve ser marcado como aprovado se a evidência (print de tela) demonstrar falha na funcionalidade.